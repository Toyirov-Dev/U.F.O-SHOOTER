...
# Background music:
backmus = pygame.mixer.Sound("Assets/Backmus.ogg")
channel1 = backmus.play()
...
while running:
	...
	if score_value == 130:
		EnemyImg = pygame.image.load('Assets/enemies/enemy14.png')
